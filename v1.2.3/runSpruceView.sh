...
echo "Make sure xmatchview-conifer.py, cross_match and minimap2 are in your PATH"

if [ ${10} == 'cross_match' ]; then

   # cross_match pipeline
   cross_match $1 $2 -minmatch 5 -minscore 10 -masklevel 101 > $1_vs_$2.rep
   xmatchview-conifer.py -x $1_vs_$2.rep -q $1 -s $2 -a $3 -m $4 -b $5 -l $6 -c $7 -f png -y $8 -e $9 -p ${11}

elif [ ${10} == 'minimap2' ]; then

   # minimap pipeline
   minimap2 $2 $1 -N200 -p0.0001 > $1_vs_$2.paf
   xmatchview-conifer.py -x $1_vs_$2.paf -q $1 -s $2 -a $3 -m $4 -b $5 -l $6 -c $7 -f png -y $8 -e $9 -p ${11}
